...
export function FullPreviewModal({ open, slides, defaultTheme, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-zeta-navy/95 flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-5xl aspect-video bg-white rounded-md overflow-hidden shadow-2xl">
        {active ? <SlideRenderer slide={active} defaultTheme={defaultTheme as any} /> : <div className="p-10 text-center text-zeta-text/50">沒有可預覽的頁面</div>}
      </div>
